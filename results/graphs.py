...
NCTraffic = pd.read_csv('results/csvs/noControlTrafficBunched.csv')
PPOTrafficBunched = pd.read_csv('results/csvs/PPOTrafficBunched.csv')
TRPOTrafficBunched = pd.read_csv('results/csvs/TRPOTrafficBunched.csv')

# dfSD = pd.read_csv('csvs/.csv')

ncVals = NCTraffic['meanWaitTime'].tolist()
ppoVals = PPOTrafficBunched['meanWaitTime'].tolist()
trpoVals = TRPOTrafficBunched['meanWaitTime'].tolist()
...
ax1.grid()
plt.legend()
plt.savefig('results/test/waitingTimeTrafficBunchedTest.jpg')
plt.show()
plt.clf()
